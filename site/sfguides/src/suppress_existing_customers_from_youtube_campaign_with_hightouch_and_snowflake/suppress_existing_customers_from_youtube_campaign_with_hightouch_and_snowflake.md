...
Hightouch helps marketers activate their customer data from Snowflake to over 125 different applications.  The [https://hightouch.com/blog/what-is-data-activation](Data Activation) platform, powered by Reverse ETL, provides both SQL and audience builders to help teams across an organization complete what is now being called the "last mile" of the [Modern Data Stack](https://hightouch.com/blog/reverse-etl-bringing-the-modern-data-stack-full-circle).

![Snowflake and Hightouch stack](assets/Snowflake_Template_The_Modern_Data_Stack_e80de39d33.jpg)

Audience targeting strategies have become increasingly important in modern marketing due to the rising cost of advertising and the increasing expectations of consumers. While there are [https://hightouch.com/blog/driving-paid-media-roas-through-audience-activation](many ways) in which organizations can target customers, one of the simplest strategies to begin leveraging to optimize advertising spend is suppression audiences.
...
*Note: Hightouch supports a number of entity relationships like [https://hightouch.com/blog/audience-builder-upgrade](Related Models) and Event Models to enable more complex targeting, however, we are going to just leverage a parent model in this Quickstart. For more information, visit: [https://hightouch.com/docs/audiences/schema](https://hightouch.com/docs/audiences/schema)*.

### Create Purchaser Audience

With the parent model defined, users can now leverage Hightouch’s no-code [https://hightouch.com/platform/audiences](audience builder) to create any audience of customers.
